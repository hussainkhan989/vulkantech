...
/* =====================================================================
   ...
   mailto link so it reaches info@vulkantech.com directly.)
===================================================================== */
function initSimpleForms() {
  document.querySelectorAll("form[data-mailto-form]").forEach((form) => {
    ...
    form.addEventListener("submit", (event) => {
      ...
      const to = form.dataset.mailtoTo || "info@vulkantech.com";
...
const FAQ_INTENTS = [
  {
    ...
    reply:
      "Hello! \uD83D\uDC4B I'm the Vulkantech assistant. Ask me about our services, pricing, contact details, or business hours - or tap one of the quick options below.",
  },
  {
    id: "services",
  ...
  },
  {
    ...
    reply: `Vulkantech is based in ${COMPANY_INFO.location}, and we work with clients worldwide, fully remote-friendly.`,
  },
  {
    id: "hours",
